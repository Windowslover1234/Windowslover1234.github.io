...
, function(t, n, e) {
    ...
    t.exports = function(t) {
        return o(d, t) || (s && o(c, t) ? d[t] = c[t] : d[t] = u("Symbol." + t)),
        d[t]
    }
}
, function(t, n) {
...
, function(t, n, e) {
    var c = e(0)
      ...
      , f = e(48);
    t.exports = function(t, n) {
        var e, i, r, o, a = t.target, s = t.global, d = t.stat;
...
, function(_, B, t) {
    (function(t) {
        ...
        function w(t, n) {
            var e, i = /function ([^(]*)\(([^)]*)\)/, r = /['"]?([0-9A-Za-z$_]+)['"]?\s*[:=]\s*(function|eval|new Function)/, o = "", a = h(t);
            if (!a.length)
                return "?";
            for (var s = 0; s < 10; ++s)
                if (!I(o = a[n - s] + o)) {
        ...
        function b(t) {
            return m(t).replace("<", "(?:<|&lt;)").replace(">", "(?:>|&gt;)").replace("&", "(?:&|&amp;)").replace('"', '(?:"|&quot;)').replace(/\s+/g, "\\s+")
        }
        function k(t, n) {
        ...
        function p(t, n, e) {
            var i, n = h(n), t = new RegExp("\\b" + m(t) + "\\b");
            return --e,
            n && n.length > e && (i = t.exec(n[e])) ? i.index : null
        }
        function d(t) {
            if (!t.stack)
                return null;
            for (var n, e, i = /^\s*at (.*?) ?\(((?:file|https?|blob|chrome-extension|native|eval|webpack|<anonymous>|\/).*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i, r = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)((?:file|https?|blob|chrome|webpack|resource|\[native).*?|[^@]*bundle)(?::(\d+))?(?::(\d+))?\s*$/i, o = /^\s*at (?:((?:\[object object\])?.+) )?\(?((?:file|ms-appx|https?|webpack|blob):.*?):(\d+)(?::(\d+))?\)?\s*$/i, a = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i, s = /\((\S*)(?::(\d+))(?::(\d+))\)/, d = t.stack.split("\n"), c = [], u = /^(.*) is undefined$/.exec(t.message), l = 0, A = d.length; l < A; ++l) {
                if (e = i.exec(d[l])) {
                    var m = e[2] && 0 === e[2].indexOf("native");
                    e[2] && 0 === e[2].indexOf("eval") && (n = s.exec(e[2])) && (e[2] = n[1],
                    e[3] = n[2],
                    e[4] = n[3]),
                    m = {
                        url: m ? null : e[2],
                    ...
                    if (!(e = r.exec(d[l])))
                        continue;
                    e[3] && -1 < e[3].indexOf(" > eval") && (n = a.exec(e[3])) ? (e[3] = n[1],
                    e[4] = n[2],
                    e[5] = null) : 0 !== l || e[5] || I(t.columnNumber) || (c[0].column = t.columnNumber + 1),
                    m = {
                        url: e[3],
                        func: e[1] || "?",
                        args: e[2] ? e[2].split(",") : [],
            ...
            return c.length ? (c[0] && c[0].line && !c[0].column && u && (c[0].column = p(u[1], c[0].url, c[0].line)),
            {
                mode: "stack",
                name: t.name,
                message: t.message,
        ...
        function f(t, n, e, i) {
            ...
            if (e.url && e.line) {
                ...
                i = / '([^']+)' /.exec(i);
                if (i && (e.column = p(i[1], e.url, e.line)),
                0 < t.stack.length && t.stack[0].url === e.url) {
                    if (t.stack[0].line === e.line)
                        return !1;
                    if (!t.stack[0].line && t.stack[0].func === e.func)
                        return t.stack[0].line = e.line,
                        t.stack[0].context = e.context,
                        !1
                }
                return t.stack.unshift(e),
                t.partial = !0
            }
            return !(t.incomplete = !0)
        }
        function v(t, n) {
            for (var e, i, r, o, a = /function\s+([_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*)?\s*\(/i, s = [], d = {}, c = !1, u = v.caller; u && !c; u = u.caller)
                if (u !== S && u !== l.report) {
                    if (i = {
                        url: null,
                        func: "?",
                    ...
                    u.name ? i.func = u.name : (e = a.exec(u.toString())) && (i.func = e[1]),
                    void 0 === i.func)
                        try {
                    ...
                    (r = function(t) {
                        if (!I(g && g.document)) {
                            for (var n, e, i, r = [g.location.href], o = g.document.getElementsByTagName("script"), a = "" + t, s = 0; s < o.length; ++s) {
                                var d = o[s];
                                d.src && r.push(d.src)
                            }
                            if (e = k((n = /^function(?:\s+([\w$]+))?\s*\(([\w\s,]*)\)\s*\{\s*(\S[\s\S]*\S)\s*\}\s*$/.exec(a)) ? (t = n[1] ? "\\s+" + n[1] : "",
                            e = n[2].split(",").join("\\s*,\\s*"),
                            i = m(n[3]).replace(/;$/, ";?"),
                            new RegExp("function" + t + "\\s*\\(\\s*" + e + "\\s*\\)\\s*{\\s*" + i + "\\s*}")) : new RegExp(m(a).replace(/\s+/g, "\\s+")), r))
                                return e;
                            if (n = /^function on([\w$]+)\s*\(event\)\s*\{\s*(\S[\s\S]*\S)\s*\}\s*$/.exec(a)) {
                                a = n[1];
                                if (i = b(n[2]),
                                e = k(new RegExp("on" + a + "=[\\'\"]\\s*" + i + "\\s*[\\'\"]","i"), r[0]))
                                    return e;
                                if (e = k(new RegExp(i), r))
                                    return e
                            }
                            return null
                        }
                    ...
                    (o = / '([^']+)' /.exec(t.message || t.description)) && (i.column = p(o[1], r.url, r.line))),
                    d["" + u] ? c = !0 : d["" + u] = !0,
                    s.push(i)
                }
            n && s.splice(0, n);
            ...
            return f(n, t.sourceURL || t.fileName, t.line || t.lineNumber, t.message || t.description),
            n
        }
        function S(t, n) {
            var e = null;
            ...
            try {
                if (e = function(t) {
                    var n = t.stacktrace;
                    if (n) {
                        for (var e, i = / line (\d+).*script (?:in )?(\S+)(?:: in function (\S+))?$/i, r = / line (\d+), column (\d+)\s*(?:in (?:<anonymous function: ([^>]+)>|([^\)]+))\((.*)\))? in (.*):\s*$/i, o = n.split("\n"), a = [], s = 0; s < o.length; s += 2) {
                            var d = null;
                            if ((e = i.exec(o[s])) ? d = {
                                url: e[2],
                                line: +e[1],
                            ...
                            d) {
                                if (!d.func && d.line && (d.func = w(d.url, d.line)),
                                d.line)
                                    try {
                                        d.context = y(d.url, d.line)
                                    } catch (t) {}
                                d.context || (d.context = [o[s + 1]]),
                                a.push(d)
                            }
                        }
                        return a.length ? {
            ...
            try {
                if (e = function(t) {
                    ...
                    if (n.length < 4)
                        return null;
                    var e, i = /^\s*Line (\d+) of linked script ((?:file|https?|blob)\S+)(?:: in function (\S+))?\s*$/i, r = /^\s*Line (\d+) of inline#(\d+) script in ((?:file|https?|blob)\S+)(?:: in function (\S+))?\s*$/i, o = /^\s*Line (\d+) of function script\s*$/i, a = [], s = g && g.document && g.document.getElementsByTagName("script"), d = [];
                    for (e in s)
                        C(s, e) && !s[e].src && d.push(s[e]);
                    for (var c = 2; c < n.length; c += 2) {
                        var u, l, A, m, p, f = null;
                        (p = i.exec(n[c])) ? f = {
                            url: p[2],
                            func: p[3],
                            args: [],
                        ...
                        u = +p[1],
                        (A = d[p[2] - 1]) && (!(l = h(f.url)) || 0 <= (A = (l = l.join("\n")).indexOf(A.innerText)) && (f.line = u + l.substring(0, A).split("\n").length))) : (p = o.exec(n[c])) && (f = {
                            url: m = g.location.href.replace(/#.*$/, ""),
                            func: "",
                            args: [],
                            line: (m = k(new RegExp(b(n[c + 1])), [m])) ? m.line : p[1],
                            column: null
                        }),
                        f && (f.func || (f.func = w(f.url, f.line)),
                        p = (m = y(f.url, f.line)) ? m[Math.floor(m.length / 2)] : null,
                        m && p.replace(/^\s*/, "") === n[c + 1].replace(/^\s*/, "") ? f.context = m : f.context = [n[c + 1]],
                        a.push(f))
                    }
                    return a.length ? {
                        mode: "multiline",
        ...
        function x(t, n, e, i, r) {
            var o, a, s, d;
            return A ? (l.computeStackTrace.augmentStackTraceWithInitialElement(A, n, e, t),
            T()) : r ? E(l.computeStackTrace(r), !0, r) : (a = {
                url: n,
                line: e,
                column: i
            },
            s = t,
            "[object String]" !== {}.toString.call(t) || (d = t.match(c)) && (o = d[1],
            s = d[2]),
        ...
        (g = "undefined" != typeof window ? window : t) && (l = {},
        e = g.TraceKit,
        i = [].slice,
        ...
        z.unsubscribe = function(t) {
            for (var n = a.length - 1; 0 <= n; --n)
                a[n] === t && a.splice(n, 1);
            0 === a.length && (g.onerror = u,
            o = !1)
        }
        ,
        z),
        l.computeStackTrace = (r = {},
            ...
            function t(t) {
                ...
                g[t] = function() {
                    var t = i.call(arguments)
                      , n = t[0];
                    return "function" == typeof n && (t[0] = l.wrap(n)),
        ...
        n = [],
        void 0 === (t = "function" == typeof (t = l) ? t.apply(B, n) : t) || (_.exports = t))
    }
    ).call(this, t(37))
}
, function(t, n, e) {
    ...
    (t.exports = function(t, n, e, i) {
        var r = !!i && !!i.unsafe
          , o = !!i && !!i.enumerable
          , i = !!i && !!i.noTargetGet;
        "function" == typeof e && ("string" != typeof n || d(e, "name") || s(e, "name", n),
        u(e).source = l.join("string" == typeof n ? n : "")),
        t !== a ? (r ? !i && t[n] && (o = !0) : delete t[n],
        o ? t[n] = e : s(t, n, e)) : o ? t[n] = e : c(n, e)
    }
...
, function(t, n, e) {
    var i, r, o, a, s, d, c, u, l = e(71), A = e(0), m = e(8), p = e(7), f = e(3), g = e(28), e = e(29), A = A.WeakMap;
    c = l ? (i = new A,
    r = i.get,
    o = i.has,
    a = i.set,
...
, function(t, n, e) {
    ...
    t.exports = e ? Object.getPrototypeOf : function(t) {
        return t = r(t),
        i(t, a) ? t[a] : "function" == typeof t.constructor && t instanceof t.constructor ? t.constructor.prototype : t instanceof Object ? s : null
    }
}
, function(t, n, e) {
    function i() {}
    ...
    var o, a = e(4), s = e(86), d = e(32), c = e(29), u = e(55), l = e(25), A = e(28)("IE_PROTO"), m = function() {
        try {
        ...
        m = o ? function(t) {
            ...
            return t = null,
            n
        }(o) : ((n = l("iframe")).style.display = "none",
        u.appendChild(n),
        ...
        for (var e = d.length; e--; )
            delete m.prototype[d[e]];
        return m()
    };
    c[A] = !0,
    t.exports = Object.create || function(t, n) {
        var e;
        return null !== t ? (i.prototype = a(t),
        e = new i,
        i.prototype = null,
        e[A] = t) : e = m(),
        void 0 === n ? e : s(e, n)
...
, function(t, n, e) {
    ...
    t.exports = function(t, n) {
        var e, i = s(t), r = 0, o = [];
        for (e in i)
            !a(c, e) && a(i, e) && o.push(e);
        for (; n.length > r; )
            a(i, e = n[r++]) && (~d(o, e) || o.push(e));
        return o
    }
}
, function(t, n, e) {
...
, function(t, n, e) {
    ...
    t.exports = i ? r : function(t) {
        ...
        }(n = Object(t), o)) ? t : a ? r(n) : "Object" == (t = r(n)) && "function" == typeof n.callee ? "Arguments" : t
    }
}
, function(t, n, e) {
    "use strict";
    ...
    t.exports = function(t, n, e, i, r, o, a) {
        ...
        var d, c, u = n + " Iterator", l = !1, A = t.prototype, m = A[z] || A["@@iterator"] || r && A[r], p = !T && m || s(r), i = "Array" == n && A.entries || m;
        if (i && (t = w(i.call(new t)),
        x !== Object.prototype && t.next && (S || w(t) === x || (y ? y(t, x) : "function" != typeof t[z] && k(t, z, f)),
        b(t, u, !0, !0),
        S && (E[u] = f))),
        "values" == r && m && "values" !== m.name && (l = !0,
        p = function() {
            return m.call(this)
        }
        ),
...
, function(t, n, e) {
    "use strict";
    var i, r = e(34), o = e(7), a = e(3), s = e(1), d = e(16), c = s("iterator"), e = !1;
    [].keys && ("next"in (s = [].keys()) ? (s = r(r(s))) !== Object.prototype && (i = s) : e = !0),
    null == i && (i = {}),
    d || a(i, c) || o(i, c, function() {
        return this
    }),
    t.exports = {
        IteratorPrototype: i,
...
, function(t, n, e) {
    ...
    var a, s = e(0), d = e(2), c = e(14), u = e(58), l = e(55), A = e(25), m = e(61), p = s.location, f = s.setImmediate, g = s.clearImmediate, h = s.process, w = s.MessageChannel, y = s.Dispatch, b = 0, k = {}, e = function(t) {
    ...
    : w && !m ? (w = (m = new w).port2,
    m.port1.onmessage = o,
    a = u(w.postMessage, w, 1)) : !s.addEventListener || "function" != typeof postMessage || s.importScripts || d(e) || "file:" === p.protocol ? a = "onreadystatechange"in A("script") ? function(t) {
...
, function(t, n, e) {
    var d = e(20)
      ...
      , e = function(s) {
        return function(t, n, e) {
            var i, r = d(t), o = c(r.length), a = u(e, o);
            if (s && n != n) {
                for (; a < o; )
                    if ((i = r[a++]) != i)
                        return !0
...
, function(t, n, e) {
    ...
    t.exports = !r || i(function() {
        ...
        for (var e = g(t), i = arguments.length, r = 1, o = p.f, a = f.f; r < i; )
            for (var s, d = h(arguments[r++]), c = o ? m(d).concat(o(d)) : m(d), u = c.length, l = 0; l < u; )
                s = c[l++],
                A && !a.call(d, s) || (e[s] = d[s]);
        return e
    }
    : r
}
...
, function(t, n, e) {
    var i = e(33)
      , r = e(12)
      , e = e(81);
    i || r(Object.prototype, "toString", e, {
        unsafe: !0
    })
}
, function(t, n, e) {
...
, function(t, n, e) {
    var a = e(31)
      ...
      , e = function(o) {
        return function(t, n) {
            var e, i = String(s(t)), r = a(n), t = i.length;
            return r < 0 || t <= r ? o ? "" : void 0 : (n = i.charCodeAt(r)) < 55296 || 56319 < n || r + 1 === t || (e = i.charCodeAt(r + 1)) < 56320 || 57343 < e ? o ? i.charAt(r) : n : o ? i.slice(r, r + 2) : e - 56320 + (n - 55296 << 10) + 65536
        }
    };
    t.exports = {
        codeAt: e(!1),
...
, function(t, n, e) {
    var i, r = e(0), o = e(89), a = e(90), s = e(7), e = e(1), d = e("iterator"), c = e("toStringTag"), u = a.values;
    for (i in o) {
        var l = r[i]
          , A = l && l.prototype;
        if (A) {
...
, function(t, n, e) {
    ...
    t.exports = e(Array, "Array", function(t, n) {
        s(this, {
            type: "Array Iterator",
            target: i(t),
            index: 0,
...
, function(t, n, e) {
    ...
    function o(l, A, m) {
        ...
        _(function() {
            for (var t = A.value, n = 1 == A.state, e = 0; p.length > e; ) {
                var i, r, o, a = p[e++], s = n ? a.ok : a.fail, d = a.resolve, c = a.reject, u = a.domain;
                try {
                    s ? (n || (2 === A.rejection && nt(l, A),
                    A.rejection = 1),
                    !0 === s ? i = t : (u && u.enter(),
                    i = s(t),
                    u && (u.exit(),
                    o = !0)),
                    i === a.promise ? c(Q("Promise-chain cycle")) : (r = f(i)) ? r.call(i, d, c) : d(i)) : c(t)
                } catch (t) {
                    u && !o && u.exit(),
                    c(t)
                }
    ...
    function r(t, n, e) {
        var i;
        Y ? ((i = H.createEvent("Event")).promise = n,
        i.reason = e,
        i.initEvent(t, !1, !0),
        m.dispatchEvent(i)) : i = {
            promise: n,
        ...
        (n = m["on" + t]) ? n(i) : "unhandledrejection" === t && P("Unhandled promise rejection", e)
    }
    function a(n, e, i, r) {
        return function(t) {
            n(e, i, t, r)
    ...
    var i, d, c, u, l = e(5), A = e(16), m = e(0), p = e(10), g = e(57), h = e(12), w = e(93), y = e(36), b = e(94), k = e(8), v = e(13), S = e(95), E = e(14), x = e(27), T = e(21), z = e(99), C = e(59), I = e(60).set, _ = e(100), B = e(63), P = e(101), D = e(18), L = e(22), O = e(15), j = e(48), R = e(1), M = e(102), Z = R("species"), G = "Promise", N = O.get, F = O.set, X = O.getterFor(G), U = g, Q = m.TypeError, H = m.document, W = m.process, V = p("fetch"), q = D.f, K = q, J = "process" == E(W), Y = !!(H && H.createEvent && m.dispatchEvent), j = j(G, function() {
        if (x(U) === String(U)) {
            if (66 === M)
                return !0;
        ...
        if (A && !U.prototype.finally)
            return !0;
        if (51 <= M && /native code/.test(U))
            return !1;
        function t(t) {
            t(function() {}, function() {})
        }
        var n = U.resolve(1);
        return (n.constructor = {})[Z] = t,
        !(n.then(function() {})instanceof t)
    }), z = j || !z(function(t) {
        U.all(t).catch(function() {})
    }), $ = function(e, i) {
        I.call(m, function() {
            var t, n = i.value;
            if (tt(i) && (t = L(function() {
                J ? W.emit("unhandledRejection", n, e) : r("unhandledrejection", e, n)
            }),
    ...
    ,
    A || "function" != typeof g || (u = g.prototype.then,
    h(g.prototype, "then", function(t, n) {
        var e = this;
...
, function(t, n, e) {
    var i, r, o, a, s, d, c, u, l = e(0), A = e(23).f, m = e(14), p = e(60).set, f = e(61), g = l.MutationObserver || l.WebKitMutationObserver, h = l.process, e = l.Promise, w = "process" == m(h), A = A(l, "queueMicrotask"), A = A && A.value;
    A || (i = function() {
        var t, n;
    ...
    ) : e && e.resolve ? (c = e.resolve(void 0),
    u = c.then,
    function() {
        u.call(c, i)
    }
...
, function(t, n, e) {
    var i, r, o = e(0), e = e(62), o = o.process, o = o && o.versions, o = o && o.v8;
    o ? r = (i = o.split("."))[0] + i[1] : e && (!(i = e.match(/Edge\/(\d+)/)) || 74 <= i[1]) && (i = e.match(/Chrome\/(\d+)/)) && (r = i[1]),
    t.exports = r && +r
}
, function(t, n, e) {
    "use strict";
    ...
    r || "function" != typeof o || o.prototype.finally || e(o.prototype, "finally", s("Promise").prototype.finally)
}
, function(t, n, e) {
    "use strict";
    var i = e(5)
...
, function(t, n, e) {
    ...
    i({
        ...
        try: function(t) {
            var n = r.f(this)
              , t = o(t);
            return (t.error ? n.reject : n.resolve)(t.value),
            n.promise
        }
    })
}
            ...
            var d = this
              ...
              , e = o(function() {
                ...
                m(t, function(t) {
                    ...
                    r.push(void 0),
                    a++,
                    i.call(d, t).then(function(t) {
                        e || s || (s = !0,
                        c(t))
                    }, function(t) {
                        e || s || (e = !0,
                        r[n] = t,
                        --a || u(new (A("AggregateError"))(r,"No one promise resolved")))
                    })
                }),
                --a || u(new (A("AggregateError"))(r,"No one promise resolved"))
            });
            return e.error && u(e.value),
            n.promise
        }
    })
}
, function(t, n) {
    !function(t) {
        ...
        function p(n) {
            this.map = {},
            n instanceof p ? n.forEach(function(t, n) {
                this.append(n, t)
        ...
        function b(t, n) {
            ...
            this.method = (t = (e = n.method || this.method || "GET").toUpperCase(),
            -1 < c.indexOf(t) ? t : e),
        ...
        t.fetch || (n = "URLSearchParams"in t,
        ...
        i = "FormData"in t,
        (r = "ArrayBuffer"in t) && (o = ["[object Int8Array]", "[object Uint8Array]", "[object Uint8ClampedArray]", "[object Int16Array]", "[object Uint16Array]", "[object Int32Array]", "[object Uint32Array]", "[object Float32Array]", "[object Float64Array]"],
        s = function(t) {
            ...
            return new Promise(function(i, t) {
                ...
                r.onload = function() {
                    var e, t = {
                        ...
                        headers: (n = r.getAllResponseHeaders() || "",
                        e = new p,
                        n.replace(/\r?\n[\t ]+/g, " ").split(/\r?\n/).forEach(function(t) {
                            var n = t.split(":")
                              , t = n.shift().trim();
    ...
    "document"in window.self && ("classList"in document.createElement("_") && (!document.createElementNS || "classList"in document.createElementNS("http://www.w3.org/2000/svg", "g")) || function(t) {
        ...
        if ("Element"in t) {
            var n = t.Element.prototype
              ...
              , s = function(t) {
                for (var n = o.call(t.getAttribute("class") || ""), e = n ? n.split(/\s+/) : [], i = 0, r = e.length; i < r; i++)
                    this.push(e[i]);
            ...
            ,
            d.add = function() {
                for (var t, n = arguments, e = 0, i = n.length, r = !1; -1 === a(this, t = n[e] + "") && (this.push(t),
                r = !0),
                ++e < i; )
                    ;
            ...
            ,
            d.remove = function() {
                var t, n, e = arguments, i = 0, r = e.length, o = !1;
                do {
            ...
            e.defineProperty) {
                ...
                e.prototype.__defineGetter__ && n.__defineGetter__("classList", c)
        }
    }(window.self),
    function() {
        "use strict";
        var t, e, n = document.createElement("_");
        n.classList.add("c1", "c2"),
        n.classList.contains("c2") || ((t = function(t) {
        ...
        n.classList.contains("c3") && (e = DOMTokenList.prototype.toggle,
...
, function(t, n, e) {
    ...
    function w() {
        ...
        window.__tcfapi = function(t, n, e, i) {
            if (!lt.GetIsPokiIFrame() && !function() {
                try {
        ...
        window.addEventListener("message", function(t) {
            ...
            e && "function" == typeof o[e.callId] && (o[e.callId](e.returnValue, e.success),
            o[e.callId] = null)
        }, !1)),
    ...
    var c = e(11)
      ...
      , b = (D.clearEventListeners = function() {
        this.listeners = {}
    }
    ,
    D.removeEventListener = function(t, n) {
        !Object.prototype.hasOwnProperty.call(this.listeners, t) || -1 !== (n = this.listeners[t].indexOf(n)) && this.listeners[t].splice(n, 1)
    }
    ,
    D.addEventListener = function(n, e, t) {
        ...
        void 0 === t && (t = !1),
        t = !!t,
        Object.prototype.hasOwnProperty.call(this.listeners, n) || (this.listeners[n] = []),
        t ? (i = function(t) {
            r.removeEventListener.bind(r)(n, i),
            e(t)
        }
        ,
        this.listeners[n].push(i)) : this.listeners[n].push(e)
    }
    ,
    D.dispatchEvent = function(t, n) {
        void 0 === n && (n = {}),
        !this.debug || window.process && window.process.env && "test" === window.process.env.NODE_ENV || console.info(t, n);
    ...
    B.track = function(t, n) {
        if (void 0 === n && (n = {}),
        -1 === f.indexOf(t))
            throw new TypeError("Invalid 'event', must be one of " + f.join(", "));
        if ("object" != typeof n)
    ...
    B.setupDefaultEvents = function() {
        var t, e = ((t = {})[y.ready] = y.tracking.sdk.status.initialized,
        ...
        t[y.ads.prebidRequested] = y.tracking.ads.status.prebidRequested,
        ...
        t[y.tracking.screen.gameplayStart] = y.tracking.screen.gameplayStart,
        t[y.tracking.screen.gameplayStop] = y.tracking.screen.gameplayStop,
        t[y.tracking.screen.loadingProgress] = y.tracking.screen.loadingProgress,
        t[y.tracking.screen.commercialBreak] = y.tracking.screen.commercialBreak,
        t[y.tracking.screen.rewardedBreak] = y.tracking.screen.rewardedBreak,
    ...
    B)
      ...
      , S = (_.prototype.setTimings = function(t) {
        var n = v.adTiming
          , e = t.preroll
    ...
    _.prototype.startTimer = function(t, n) {
        ...
        this.getTiming(t) <= 0 ? n() : (this.timers[t] && clearTimeout(this.timers[t]),
    ...
    _)
      , E = function(t, n) {
        if ("undefined" == typeof window)
            return "";
        t = t.replace(/[\[]/, "\\[").replace(/[\]]/, "\\]");
        n = new RegExp("[\\?&]" + t + "=([^&#]*)").exec(n || window.location.search);
      ...
      , i = function() {
        ...
        for (var i = Array(t), r = 0, n = 0; n < e; n++)
            for (var o = arguments[n], a = 0, s = o.length; a < s; a++,
            r++)
                i[r] = o[a];
        return i
    }
      , r = (o = parseInt(E("site_id"), 10) || 0,
    r = d() || g() || h() ? ["video/mp4"] : ["video/mp4", "video/webm", "video/ogg"],
    {
        bids: [{
            bidder: "appnexus",
            params: T(T({
    ...
    function _(t) {
        ...
        b.addEventListener(y.ads.requested, this.startTimeBetweenAdsTimer.bind(this)),
        b.addEventListener(y.ads.completed, this.startTimeBetweenAdsTimer.bind(this)),
        b.addEventListener(y.ads.stopped, this.startTimeBetweenAdsTimer.bind(this))
    }
    function B() {}
    function P() {}
    function D() {}
    var L = (G.prototype.moveThroughWaterfall = function() {
        if (!1 !== this.running) {
    ...
    G.prototype.buildAdTagUrls = function(t) {
        ...
        if (this.debug) {
            ...
            return t === y.ads.position.rewarded ? [e + "debug-video-rewarded" + n] : t === y.ads.position.preroll ? [e + "debug-video-preroll" + n] : [e + "debug-video-midroll" + n]
        }
        ...
        t = "https://securepubads.g.doubleclick.net/gampad/ads?sz=640x360|640x480&iu=/21682198607/";
        return lt.GetIsPokiIFrame() ? [t + i + "_ingame_" + e + "_1/" + this.siteID + "_" + i + "_ingame_" + e + "_1" + n, t + i + "_ingame_" + e + "_2/" + this.siteID + "_" + i + "_ingame_" + e + "_2" + n] : [t + "external_" + i + "_video_1/external_" + i + "_ingame_" + e + "_1" + n, t + "external_" + i + "_video_2/external_" + i + "_ingame_" + e + "_2" + n]
    }
    ,
    ...
    G.prototype.requestAd = function() {
        ...
        var t = (this.retries - 1) % this.adTagUrls.length
          , n = this.adTagUrls[t];
        lt.consentString && 0 < lt.consentString.length && (this.criteria.consent_string = lt.consentString);
        var e, i, r, o, a, s, d, c, u, l, n = (t = n,
        n = A().split("?"),
        n = encodeURIComponent(n[0]),
        (t = t.split("{descriptionUrl}").join(n)).split("{timestamp}").join((new Date).getTime().toString()) + (e = this.criteria,
        i = "",
        Object.keys(e).forEach(function(t) {
            var n;
            Object.prototype.hasOwnProperty.call(e, t) && (n = e[t],
        ...
        b.setDataAnnotations({
            adTagUrl: n,
            waterfall: this.retries
        }),
        b.dispatchEvent(y.ads.requested),
        1 !== this.retries || g() || h() ? (console.debug("adRequest started in plain mode"),
        this.ima.requestAd(n)) : (console.debug("adRequest started with Prebid Video enabled"),
        r = this.ima,
        o = n,
        a = this.criteria,
        t = this.rewarded,
        window.pbjs && window.pbjs.que && window.pbjs.getConfig ? (n = A().split("?"),
        ...
        l = function() {
            if (!(0 < --u))
                try {
                    ...
                    s && (t = t.replace("cust_params=", "cust_params=" + s + "%26")),
                    r.requestAd(t)
                } catch (t) {
                    r.requestAd(o)
                }
        ...
        window.apstag.fetchBids({
            ...
            0 < t.length && (s = t[0].encodedQsParams),
            l()
        })),
        window.pbjs.que.push(function() {
    ...
    G)
      , O = "pokiSdkVisible"
      , j = (Z.prototype.setupEvents = function(t) {
        this.internalSDK = t
    }
    ,
    ...
    Z.prototype.createElements = function() {
        ...
        this.wrapper === document.body ? this.containerDiv.classList.add("pokiSdkFixed") : (t = window.getComputedStyle(this.wrapper).position) && -1 !== ["absolute", "fixed", "relative"].indexOf(t) || (this.wrapper.style.position = "relative")
    }
    ,
    Z)
      , R = !0
    ...
    function Z(t) {
        ...
        this.hideElement = function(t) {
            t.classList.add("pokiSdkHidden"),
            t.classList.remove(O)
        }
        ,
        this.showElement = function(t) {
            t.classList.add(O),
            t.classList.remove("pokiSdkHidden")
        }
        ,
    ...
    function G(t, n) {
        ...
        b.addEventListener(y.ads.video.error, this.moveThroughWaterfall.bind(this)),
        b.addEventListener(y.ads.video.loaderError, this.moveThroughWaterfall.bind(this)),
        b.addEventListener(y.ads.ready, this.timing.stopWaterfallTimer.bind(this.timing)),
    ...
    function H(t, a, s, d) {
        return new (s = s || Promise)(function(e, n) {
            ...
            function o(t) {
                var n;
                t.done ? e(t.value) : ((n = t.value)instanceof s ? n : new s(function(t) {
                    t(n)
                }
                )).then(i, r)
            }
            ...
            return function(t) {
                return function(n) {
                    ...
                    for (; s; )
                        try {
                            if (r = 1,
                            o && (a = 2 & n[0] ? o.return : n[0] ? o.throw || ((a = o.return) && a.call(o),
                            0) : o.next) && !(a = a.call(o, n[1])).done)
                                return a;
                            switch (o = 0,
                            a && (n = [2 & n[0], a.value]),
                            n[0]) {
                            ...
                            case 7:
                                ...
                                continue;
                            default:
                                if (!((a = 0 < (a = s.trys).length && a[a.length - 1]) || 6 !== n[0] && 2 !== n[0])) {
                                    s = 0;
                                    continue
                                }
    ...
    function V(r) {
        return new Promise(function(t, n) {
            ...
            e.src = r;
            function i() {
                e.readyState && "loaded" !== e.readyState && "complete" !== e.readyState || (t(),
                e.onload = null,
    ...
    var J = (Y.prototype.initAdDisplayContainer = function() {
    ...
    Y.prototype.requestAd = function(e) {
        return H(this, void 0, void 0, function() {
            ...
            return W(this, function(t) {
                ...
                case 1:
                    return t.sent() ? (n.setAdWillPlayMuted(!1),
    ...
    Y.prototype.onAdsManagerLoaded = function(t) {
        ...
        n.mimeTypes = d() || g() || h() ? ["video/mp4"] : ["video/mp4", "video/webm", "video/ogg"],
        ...
        b.dispatchEvent(y.ads.ready)) : this.tearDown()
    }
    ,
    ...
    Y.prototype.onAdEvent = function(t) {
        ...
        case google.ima.AdEvent.Type.STARTED:
            ...
            e.isLinear() || (this.bannerTimeout = window.setTimeout(function() {
        ...
        case google.ima.AdEvent.Type.PAUSED:
            ...
            b.dispatchEvent(y.ads.video.paused);
            break;
        ...
        case google.ima.AdEvent.Type.IMPRESSION:
            b.dispatchEvent(y.ads.impression, {
                userValueIndicator: function(t) {
                    try {
                        ...
                        if (n) {
                            for (var i, r = 0; r < n.length; r++)
                                window.pokiAuctionsSeen[t][n[r].auctionId] || (i = n[r].cpm) && e < i && (e = i);
                    ...
                    return 0
                }(b.getDataAnnotations().position === y.ads.position.rewarded ? "rewarded" : "video")
            })
        }
    }
    ,
    Y.prototype.onAdLoaderError = function(t) {
        ...
        b.dispatchEvent(y.ads.video.loaderError, {
            message: t
        })
    }
    ,
    Y.prototype.onAdError = function(t) {
        this.tearDown();
        t = t.getError && t.getError().toString() || "Unknown";
        b.dispatchEvent(y.ads.video.error, {
            message: t
        })
    }
    ,
    ...
    function $() {
        ...
        return "/" !== t[0] && (t = "/" + t),
        encodeURIComponent(window.location.protocol + "//" + window.location.host + t + window.location.search),
        ...
        fetch("", {
            ...
            return q(void 0, void 0, void 0, function() {
                ...
                return K(this, function(t) {
                    switch (t.label) {
                    case 0:
                        return 200 <= e.status && e.status < 400 ? [4, e.json()] : [3, 2];
                    case 1:
                        return (n = t.sent()).game_id ? [2, {
                            gameId: n.game_id,
                            adTiming: {
                ...
                return q(this, void 0, void 0, function() {
                    ...
                    return K(this, function(t) {
                        ...
                        case 0:
                            ...
                            "/" !== (n = window.location.pathname)[0] && (n = "/" + n),
                            r = (i = JSON).stringify,
                            o = {
                                c: "sdk-p4d-error",
                                ve: 7
                        ...
                        case 1:
                            ...
                            t.label = 2;
                        case 2:
                            if (e = r.apply(i, [(o.d = [(a.v = d.apply(s, [(c.json = u,
        ...
        return d = function() {
            ...
            r = function(t) {
                ...
                case 2:
                    return [4, t.sent().json()];
                case 3:
                    return (n = t.sent()) && ((e = document.createElement("script")).src = "//game-cdn.poki.com/scripts/touchOverlayController.js",
                    e.onload = function() {
                ...
                return function(t) {
                    return function(n) {
                        ...
                        for (; d; )
                            try {
                                if (o = 1,
                                a && (s = 2 & n[0] ? a.return : n[0] ? a.throw || ((s = a.return) && s.call(a),
                                0) : a.next) && !(s = s.call(a, n[1])).done)
                                    return s;
                                switch (a = 0,
                                s && (n = [2 & n[0], s.value]),
                                n[0]) {
                                ...
                                case 7:
                                    ...
                                    continue;
                                default:
                                    if (!((s = 0 < (s = d.trys).length && s[s.length - 1]) || 6 !== n[0] && 2 !== n[0])) {
                                        d = 0;
                                        continue
                                    }
    ...
    var rt = e(67)
      ...
      , dt = function(e) {
        googletag.cmd.push(function() {
            var t = it(e)
              , n = st.get(t || "") || null;
            n && n.gptSlot && (k.track(y.tracking.screen.destroyAd, {
                opportunityId: n.opportunityId
            }),
            googletag.destroySlots([n.gptSlot]),
            null === (t = e.querySelector("div#" + n.id)) || void 0 === t || t.remove(),
      ...
      , lt = (At.prototype.init = function(t) {
        if (void 0 === t && (t = {}),
    ...
    At.prototype.lazyLoadInit = function() {
        var t, i = this, n = this.initOptions, e = n.adTagUrl, r = n.adTiming, o = void 0 === r ? {} : r, a = n.customCriteria, s = void 0 === a ? {} : a, d = n.debug, r = void 0 !== d && d, a = n.prebid, d = void 0 === a ? {} : a, a = n.a9, c = void 0 === a ? {} : a, a = n.volume, u = void 0 === a ? 1 : a, l = n.waterfallRetries, n = n.wrapper, A = void 0 === n ? document.body : n, m = parseInt(E("site_id"), 10) || 0;
        ...
        s = $;
        (At.isPokiPlatform || this.debug) && (s = function() {
        ...
        Promise.all([s(), o(), V(""), V(""), V(rt.a), V("")]).catch(function() {
            ...
            n && (ut.gameId || (ut.gameId = n.gameId),
            ["7fb1fd45-24ce-4ade-b5c4-9ee55ec99526"].includes(ut.gameId) && (g() || h()) && nt(),
            ...
            i.enableSettings(t),
            (n = U(i.country)) && (At.GetIsPokiPlatform() || At.GetIsPokiIFrame()) && w(),
            i.playerSkin = new j({
                wrapper: A
            }),
            i.ima = new J(u),
            i.playerSkin.setupEvents(i),
            i.startStartAdsAfterTimerOnInit && i.adTimings.startStartAdsAfterTimer(),
            ...
            window.googletag.cmd.push(function() {
                window.googletag.pubads().addEventListener("slotRenderEnded", function(t) {
                    t = t.slot.getSlotElementId(),
                    t = st.get(t);
                    t && t.gptSlot && k.track(y.tracking.ads.display.impression, {
                        size: t.size,
                ...
                window.googletag.pubads().addEventListener("impressionViewable", function(t) {
                    t = t.slot.getSlotElementId(),
                    t = st.get(t);
                    t && t.gptSlot && k.track(y.tracking.ads.display.viewable, {
                        size: t.size,
                        opportunityId: t.opportunityId,
                        adUnitPath: t.adUnitPath
                    })
            ...
            e = c,
            window.apstag && window.apstag.init(e.settings || T({
    ...
    At.prototype.requestAd = function(o) {
        ...
        function t() {
            ...
            if (a.autoStartOnReady = !1 !== t,
            e && a.registerHandler("onFinish", e),
            i && a.registerHandler("onStart", i),
            a.forceDisableCommercialBreak && [y.ads.position.midroll, y.ads.position.preroll].includes(r))
                e && e();
            else {
                if (!a.sdkBooted)
                ...
                a.sdkImaError ? b.dispatchEvent(y.ads.error, {
                    message: "Adblocker has been detected"
                }) : !g() && !h() || r === y.ads.position.rewarded ? null !== r && s(r, y.ads.position) ? a.ima.isAdRunning() || a.waterfall.isRunning() ? b.dispatchEvent(y.ads.busy) : a.adReady ? b.dispatchEvent(y.ads.ready) : r !== y.ads.position.preroll || a.adTimings.prerollPossible() ? r === y.ads.position.rewarded || a.adTimings.requestPossible() ? (e = ct(ct(ct({}, a.genericCriteria()), a.criteria), {
                    position: r
                }),
                !At.isPokiPlatform && r !== y.ads.position.rewarded || (e = ct(ct({}, e), n)),
                a.playerSkin.showWithOpacity(),
                a.resize(),
                a.waterfall.start(e, r)) : b.dispatchEvent(y.ads.limit, {
                    reason: y.info.messages.timeLimit
                }) : b.dispatchEvent(y.ads.limit, {
                    reason: y.info.messages.prerollLimit
                }) : console.error("POKI-SDK: Invalid position") : b.dispatchEvent(y.ads.error, {
    ...
    At.prototype.displayAd = function(d, c) {
        function t() {
            b.clearAnnotations();
            var n, e, i, r, t = et(), o = y.ads.position.display;
            if (c) {
                if (!u.sdkBooted)
                    return b.dispatchEvent(y.ads.error, {
                        message: "Requesting ad on unbooted SDK",
                ...
                if (d)
                    if (u.sdkImaError)
                        ...
                        if (s = c,
                        !(g() || h() || ["970x250", "300x250", "728x90", "160x600", "320x50"].includes(s)) || (g() || h()) && !["320x50"].includes(s))
                            return b.dispatchEvent(y.ads.error, {
                                reason: "Display size " + c + " is not supported on this device",
                                position: o
                            });
                        var a = ct(ct({}, u.genericCriteria()), u.criteria)
                          , s = function(n, t) {
                            ...
                            var r = function(t) {
                                ...
                                return at || (e = lt.GetIsPokiIFrame() ? "/21682198607/" + i + "_ingame_" + t + "/" + r + "_" + i + "_ingame_" + t : "/21682198607/external_" + i + "_display_ingame/external_" + i + "_ingame_" + t),
                                {
                                    id: "poki-" + et(),
                                    adUnitPath: e,
                                    size: t,
                            ...
                            googletag.cmd.push(function() {
                                ...
                                r.gptSlot = googletag.defineSlot(r.adUnitPath, [r.width, r.height], r.id).addService(googletag.pubads()),
                        ...
                        googletag.cmd.push(function() {
                            var t, e = st.get(i);
                            e && e.gptSlot && (null === (t = e.gptSlot) || void 0 === t || t.clearTargeting(),
                            Object.keys(r).forEach(function(t) {
                                var n;
                                null === (n = e.gptSlot) || void 0 === n || n.setTargeting(t, r[t])
                            }))
                        }),
                        n = s,
                        e = t,
                        googletag.cmd.push(function() {
                            var t = st.get(n);
                            t && t.gptSlot && (t.opportunityId = e,
                            k.track(y.tracking.ads.display.requested, {
                                size: t.size,
                                opportunityId: t.opportunityId,
                                adUnitPath: t.adUnitPath
                            }),
                            t.refresh && t.gptSlot ? googletag.pubads().refresh([t.gptSlot]) : (googletag.display(t.id),
                            t.refresh = !0,
                            st.set(t.id, t)))
                        })
                    }
    ...
    At.prototype.destroyAd = function(t) {
        function n() {
            if (!e.sdkBooted)
                return b.dispatchEvent(y.ads.displayError, {
                    message: "Attempting destroyAd on unbooted SDK"
                }),
                void e.sdkNotBootedButCalled();
            e.sdkImaError ? b.dispatchEvent(y.ads.displayError, {
                message: "Adblocker has been detected"
            }) : (t = t || document.body,
            dt(t))
        }
    ...
    At.prototype.togglePlayerAdvertisingConsent = function(t) {
        ...
        t = F.includes(i),
        i = Q(i),
        (e || t || Q) && (e && n <= 12 || t && n <= 16 || i && n <= 16) ? this.disableProgrammatic() : this.enableProgrammatic()) : this.disableProgrammatic()
    }
    ,
    ...
    At.prototype.setDebug = function(t) {
        var n = this;
        this.debugIsOverwritten ? t && k.track(y.tracking.debugTrueInProduction) : (k.setDebug(t),
        b.setDebug(t),
        this.waterfall ? this.waterfall.setDebug(t) : b.addEventListener(y.ready, function() {
    ...
    At.prototype.resize = function() {
        ...
        this.sdkImaError || (0 !== (t = this.playerSkin.getVideoBounds()).width && 0 !== t.height ? this.ima.resize(t.width, t.height) : setTimeout(function() {
            n.resize()
        }, 100))
    }
    ,
    ...
    At.prototype.startAd = function() {
        if (!this.sdkBooted)
            return this.sdkNotBootedButCalled();
        this.sdkImaError || (this.adReady ? (this.playerSkin.show(),
        this.resize(),
        this.ima.startPlayback()) : b.dispatchEvent(y.ads.error, {
    ...
    At.prototype.setupDefaultEvents = function() {
        ...
        [y.ads.limit, y.ads.stopped, y.ads.error, y.ads.busy, y.ads.completed].forEach(function(t) {
            b.addEventListener(t, function() {
                n.playerSkin && n.playerSkin.hide(),
                n.adReady = !1
            })
        })
    }
    ...
    var ft = Date.now()
      , gt = (e = new RegExp("poki_erruid=([^;]+)(?:;|$)").exec(document.cookie)) ? e[1] : "";
    function ht(t) {
        if (ut.gameId && ut.versionId) {
            if (!(Date.now() < ft)) {
                gt || (r = gt = Math.random().toString(36).substr(2, 9),
                document.cookie = "poki_erruid=" + r + "; path=/; samesite=lax; max-age=63072000; domain=" + pt);
                try {
                    ...
                    navigator.sendBeacon ? navigator.sendBeacon(i, e) : ((n = new XMLHttpRequest).open("POST", i, !0),
                    n.send(e)),
                    ft = Date.now() + 100
                } catch (t) {
                    console.error(t)
    ...
    function yt(t, n, e) {
        var i;
        null != t && ((i = t[n]) && i.__poki__ || (t[n] = e(i),
        t[n].__poki__ = !0,
        t[n].__orig__ = i))
    }
    function bt(i) {
        ...
        try {
            if (i.__poki__)
                return i;
            if (i.__poki_wrapper__)
                return i.__poki_wrapper__
        } catch (t) {
            return i
        }
        function t() {
            ...
            try {
                ...
                return window.pokiLastCatch = null,
                e
            } catch (t) {
    ...
    function kt(o) {
        return function(t, n) {
            for (var e = new Array(arguments.length), i = 0; i < e.length; ++i)
                e[i] = arguments[i];
            var r = e[0];
            return wt(r) && (e[0] = bt(r)),
            o.apply ? o.apply(this, e) : o(e[0], e[1])
        }
    }
    "undefined" != typeof window && (u.a.remoteFetching = !1,
    u.a.report.subscribe(function(t) {
        var n;
        "Script error." === t.message && window.pokiLastCatch ? (n = window.pokiLastCatch,
        window.pokiLastCatch = null,
        u.a.report(n)) : ht(t)
    }),
    window.onunhandledrejection = function(t) {
        mt(t.reason) ? u.a.report(t.reason) : ht({
            name: "unhandledrejection",
            message: JSON.stringify(t.reason)
        })
    }
    ,
    "bd6bdd9e-33a9-11ea-a08a-acde48001122" === ut.gameId && (["EventTarget", "Window", "Node", "ApplicationCache", "AudioTrackList", "ChannelMergerNode", "CryptoOperation", "EventSource", "FileReader", "HTMLUnknownElement", "IDBDatabase", "IDBRequest", "IDBTransaction", "KeyOperation", "MediaController", "MessagePort", "ModalWindow", "Notification", "SVGElementInstance", "Screen", "TextTrack", "TextTrackCue", "TextTrackList", "WebSocket", "WebSocketWorker", "Worker", "XMLHttpRequest", "XMLHttpRequestEventTarget", "XMLHttpRequestUpload"].forEach(function(t) {
        (t = window[t] && window[t].prototype) && t.hasOwnProperty && t.hasOwnProperty("addEventListener") && (yt(t, "addEventListener", function(r) {
    ...
    void 0 !== window.requestAnimationFrame && yt(window, "requestAnimationFrame", function(n) {
        return function(t) {
            return n(bt(t))
        }
    })));
    ...
    }, Et = (xt.prototype.setDebug = function(t) {
        void 0 === t && (t = !0),
        this.SDK.setDebug(t)
    }
    ,
    ...
    xt.prototype.displayAd = function(t, n) {
        k.track(y.tracking.screen.displayAd, {
            size: n
        }),
    ...
    function xt() {
        ...
        this.init = function(e) {
            ...
            new Promise(function(t, n) {
                ...
                m.sendMessage(y.message.sdkDetails, {
                    version: "2.150.0"
                })
            }
            )
        ...
        this.gameplayStart = function(t) {
            ...
            k.track(y.tracking.screen.gameplayStart, St(St({}, t), {
        ...
        this.gameplayStop = function(t) {
            ...
            k.track(y.tracking.screen.gameplayStop, St(St({}, t), {
                playId: i.gameplayStartCounter,
        ...
        this.roundStart = function(t) {
            void 0 === t && (t = ""),
            t = String(t),
            k.track(y.tracking.screen.roundStart, {
                identifier: t
            })
        }
        ,
        this.roundEnd = function(t) {
            void 0 === t && (t = ""),
            t = String(t),
            k.track(y.tracking.screen.roundEnd, {
                identifier: t
            })
        }
        ,
        ...
        this.commercialBreak = function() {
            return new Promise(function(t) {
                var n = i.gameStarted ? y.ads.position.midroll : y.ads.position.preroll;
                b.clearAnnotations(),
                b.setDataAnnotations({
                    opportunityId: et(),
                    position: n
        ...
        this.happyTime = function(t) {
            void 0 === t && (t = 1),
            ((t = Number(t)) < 0 || 1 < t) && (t = Math.max(0, Math.min(1, t)),
            i.warning("happyTime", "Intensity should be a value between 0 and 1, adjusted to " + t)),
            k.track(y.tracking.screen.happyTime, {
                intensity: t
            })
        }
        ,
        ...
        ,
        this.setPlayerAge = function(t) {
            k.track(y.tracking.setPlayerAge, {
                age: t
            }),
        ...
        this.togglePlayerAdvertisingConsent = function(t) {
            k.track(y.tracking.togglePlayerAdvertisingConsent, {
                didConsent: t
            }),
